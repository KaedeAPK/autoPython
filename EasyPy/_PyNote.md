...
* Django Girls Tutorial
    ...
    * まで進みました。
* django girlsでのリストやオブジェクトなどの総復習
* Virtual environmentの構築
* Blogの作成、Admin画面での記事の複数作成
* Articleは指示の通り飛ばして今はURLの記事の途中です。

## 気付いたところ
* 「問題の無いところに問題を作ってしまう」ミスをまたしてしました...
    * ミスが活かせるようにそこから得られるものを覚えます！
    * 今回：コマンドにcurrent directoryまで入力していた
        * どこからがコマンドなのか意識して打つ
* Nuxtで作っていた時の知識と合わせて、サイト構築の大まかな流れが掴めた


## 苦労したところ
* はじめて聞くことが多くて読んで咀嚼するのに時間がかかりました。
-------------end--------------